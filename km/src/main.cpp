...
NTSTATUS driver_main(PDRIVER_OBJECT driver_object, PUNICODE_STRING registry_path) {
	...
	RtlInitUnicodeString(&device_name, L"\\Driver\\kernel_drivers");
	...
	RtlInitUnicodeString(&symbolic_link, L"\\DosDevices\\kernel_drivers");
...
NTSTATUS DriverEntry() {
	...
	RtlInitUnicodeString(&driver_name, L"\\Driver\\kernel_drivers");
